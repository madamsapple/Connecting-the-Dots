...
function init() {
    ...
    loader.load('./fonts/Montserrat_Regular.json', function (font) {
        ...
        for (let word in uniq_words) {
            ...
            // for (var i=0; i < title_and_coord.length; i++) {
            //     console.log("yeah we're in here!");
            // }
            // Object.entries(title_and_coord).map(entry => {
            //     let a = entry[0];
            //     let b = entry[1];
            //     console.log(a, b);
            // });
    
            //let abc = Object.values(title_and_coord);
    
            //title and coord is not a dict obj since title_and_coord[2] returns undefined
...
//     //loop through every title
//     Object.keys(title_and_coord).forEach(function(sentence) {
//         var lwrcase = sentence.toLowerCase();
//         if (lwrcase.includes[key]){

//             //append the coord of title to list/array initialized before the loop
//             shared_coords.push(title_and_coord[sentence]);
//         }
